...
jQuery.validator.addMethod("isValidInventoryCombo", function(value, element) {
  var inventoryCombo = $("#inputINVENTORYCombo").val();
  var inventoryPro1 = $("#inputInventoryProduct1").val();
  var inventoryPro2 = $("#inputInventoryProduct2").val();
  var inventoryPro3 = $("#inputInventoryProduct3").val();
