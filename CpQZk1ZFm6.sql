...
(1, 'Bio Bio Baby'),
(2, 'Bio Lady và Bio Mama'),
(3, 'Tanamera\r\n'),
(4, 'Apple Monkey\r\n'),
(5, 'Bentley Organic'),
(6, 'Zao organic make up');
...
INSERT INTO `customer` (`ID`, `USERNAME`, `PASSWORD`, `IMAGE`, `FULLNAME`, `EMAIL`, `BIRTHDATE`, `CASH`, `CUSTOMERTYPEID`, `STATUS`, `CREATED`) VALUES
(1, 'qui.lt', '123456', 'http://thuthuat123.com/uploads/2018/01/27/Avatar-dep-nhat-83_112148.jpg', 'Lê Tường Qui', 'qui021098@gmail.com', '1998-12-25', 200000, 1, 1, '2019-05-01'),
(2, 'ly.nt', '123456', 'https://cdn.pixabay.com/photo/2016/11/18/23/38/child-1837375_960_720.png', 'Nguyễn Thiên Lý', 'thienly@gmail.com', '1998-12-22', 3000000, 2, 1, '2019-05-09'),
(3, 'linh.tk', '123456', 'https://cdn.iconscout.com/icon/free/png-256/avatar-373-456325.png', 'Trần Khánh Linh', 'khanhlinh@gmail.com', '1998-10-16', 1300000, 1, 1, '2019-05-01');
