    ...
    $.ajax({
      ...
      success: function(result) {
        ...
        if (jsonResult.valid == true) {
          ...
          //Thông báo lỗi
          $("#alert-update-avatar").remove();
          var alert =
            '<div class="alert alert-warning alert-dismissible fade show" id="alert-update-avatar" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>Lỗi hệ thống. Cập nhật ảnh đại diện thất bại!</div>';
          $("#frmupdate-avatar").prepend(alert);
        }
      }
    });
  }
